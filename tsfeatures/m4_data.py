# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/04_m4_data.ipynb.

# %% auto 0
__all__ = ['seas_dict', 'SOURCE_URL', 'maybe_download', 'm4_parser', 'prepare_m4_data']

# %% ../nbs/04_m4_data.ipynb 2
import os
import subprocess
import urllib
